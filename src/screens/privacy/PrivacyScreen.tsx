    ...
    <GreenWhiteLayout>
      <div className="text-wrapper">
        ...
        <p>
          ...
          {companyName} and governs data collection and usage. For the purposes
          ...
          website and applications, you consent to the data practices described
          in this statement.
        </p>
        ...
        <p>
          {companyName} collects and uses your personal information to operate
        ...
        <p>
          ...
          these services to {companyName}, and they are required to maintain the
          confidentiality of your information.
        </p>
        <p>
          {companyName} may disclose your personal information, without notice,
          ...
          with legal process served on {companyName} or the site; (b) protect
          and defend the rights or property of {companyName}; and/or (c) act
        ...
        <p>
          ...
          via email from {companyName}, you may opt out of such communications
          by clicking the unsubscribe link in the email message.
        </p>
        <h4>External Data Storage</h4>
        <p>
          Sites We may store your data on servers provided by third party
          hosting vendors with whom we have contracted.
        </p>
        <h4>Changes to this Statement</h4>
        <p>
          {companyName} reserves the right to change this Privacy Policy from
        ...
        <p>
          ...
          Statement of Privacy. If you believe that {companyName} has not
          adhered to this Statement, please contact {companyName} at:
        </p>
        <p>
          {companyName}
          <br />
